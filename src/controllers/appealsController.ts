...
import { createAppealsList, findAppealsByDateQuery, createAppeal, takeAppealOnWork, completeAppeal, cancelAppeal, cancelAllAppeals } from '@/entities/appeals/index';
import { errorHandler, isValidDate } from './utils';

export const createAppealCtrl = async (req: Request, res: Response) => {
  try {
    const { body } = req
...
export const takeAppealCtrl = async (req: Request, res: Response) => {
  try {
    const { id } = req.query;
...
export const completeAppealCtrl = async(req: Request, res: Response) => {
  try {
    const { id } = req.query;
...
export const cancelAppealCtrl = async (req: Request, res: Response) => {
  try {
    const { id } = req.query;
...
export const cancelAllAppealsCtrl = async (req: Request, res: Response) => {
  try {
...
export const listAppealsCtrl = async (req: Request, res: Response) => {
  try {
